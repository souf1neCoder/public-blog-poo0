...
if (isset($_GET['id_user']) && !empty($_GET['id_user'])) {
    ...
    $posts = $saveController->getSavedPostsByUser(filter_var($_GET['id_user'], FILTER_SANITIZE_NUMBER_INT));
} else {
    Redirect::to("home");
    exit;
}
...
<section class="posts_section mt-5">
    <div class="container-fluid">
        ...
        <div class="row mt-5">
            <div class="col-lg-9">
            <h2 class="mt-5 mb-3 head_section">Saved Posts <span class="logo_span">POO0</span></h2>
                        ...
                        <div class="col-lg-6 my-4">
                            ...
                            <article class="article">
                                ...
                                <div class="article_body">
                                    <h6><?php echo $postsController->timeAgoController($post['post_date']) ?> - <?php echo $post['post_author'] ?> - <?php echo $categoriesController->getCategoryByIdController($post['categorie']) ?></h6>
