...
$posts = $postsController->MostViewedArticlesContrlr($offset, $limit);
    ...
    <div class="container-fluid">
        ...
        <div class="row mt-5">
            <div class="col-lg-9">
                ...
                <h2 class="mt-5 mb-3 head_section">Most Viewed <span class="logo_span">POO0</span></h2>
        ...
        <?php
        $totalArticlesRecent = $postsController->MostViewedArticlesPagesContrlr()['result'];
        $rowCount = $postsController->MostViewedArticlesPagesContrlr()['rowCount'];
        if ($rowCount > 0) {
