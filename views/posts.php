...
if (isset($_GET['category']) && !empty($_GET['category'])) {
    ...
    $posts = $postsController->getPostsByCategoryController($category, $offset, $limit);
} else {
    $posts = $postsController->getpostsController($offset, $limit);
}
...
?>
<?php require_once './views/includes/mainCatPosts.php' ?>
    ...
    <div class="container-fluid">
        ...
        <div class="row mt-5">
            <div class="col-lg-9">
                ...
                <h2 class="mt-5 mb-3 head_section">Recent Posts <span class="logo_span">POO0</span></h2>
                ...
                if (isset($_GET['category']) && !empty($_GET['category'])) {
                    $category = htmlentities($_GET['category']);
                    $totalArticlesRecent = $postsController->getPostsByCategoryPagesContrlr($category)['result'];
                    $rowCount = $postsController->getPostsByCategoryPagesContrlr($category)['rowCount'];
                } else {

                    $totalArticlesRecent = $postsController->getArticlesLimitRecentContrlr()['result'];
                    $rowCount = $postsController->getArticlesLimitRecentContrlr()['rowCount'];
                }
                if ($rowCount > 0) {
